    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <h6>Elemek</h6>
                <div id="tools">
                    <span draggable="false" ondragstart="drag(event)" class="mail toolIcon clickableIcon" name="E-mail"><i
                            class="fas fa-at fa-2x"></i></span> <!-- Email cim -->
                    <span draggable="false" ondragstart="drag(event)" class="date toolIcon clickableIcon" name="Dátum"><i
                            class="fas fa-calendar-alt fa-2x"></i></span> <!-- Datum -->
                    <span draggable="false" ondragstart="drag(event)" class="date_time toolIcon clickableIcon" name="Idő"><i
                            class="fas fa-clock fa-2x"></i></span> <!-- Ido -->
                    <span draggable="false" ondragstart="drag(event)" class="heading toolIcon clickableIcon"
                        name="Szakaszcím"><i class="fas fa-heading fa-2x"></i></span> <!-- Szakaszcim -->
                    <span draggable="false" ondragstart="drag(event)" class="paragraph toolIcon clickableIcon"
                        name="Szakasz bekezdés"><i class="fas fa-paragraph fa-2x"></i></span> <!-- Szakasz bekezdes -->
                    <span draggable="false" ondragstart="drag(event)" class="tinytext toolIcon clickableIcon"><i
                            class="fas fa-grip-lines fa-2x"></i></span> <!-- Rovid szoveg -->
                    <span draggable="false" ondragstart="drag(event)" class="longtext toolIcon clickableIcon"
                        name="Hosszú szöveg"><i class="fas fa-align-justify fa-2x"></i></span> <!-- Hosszu szoveg -->
                    <span draggable="false" ondragstart="drag(event)" class="radio toolIcon clickableIcon"
                        name="Feleletválasztós"><i class="fas fa-circle fa-2x"></i></span> <!-- Feleletvalasztos -->
                    <span draggable="false" ondragstart="drag(event)" class="checkbox toolIcon clickableIcon"
                        name="Jelölőnégyzet"><i class="far fa-check-square fa-2x"></i></span> <!-- Jelolonegyzet -->
                    <span draggable="false" ondragstart="drag(event)" class="dropdown toolIcon clickableIcon"
                        name="Legördülő lista"><i class="fas fa-arrow-circle-down fa-2x"></i></span>
                    <!-- Legordulo lista -->
                    <span draggable="false" ondragstart="drag(event)" class="scale toolIcon clickableIcon"
                        name="Lineáris skála"><i class="fas fa-sort-numeric-up fa-2x"></i></span> <!-- Linearis skala -->
                </div>
