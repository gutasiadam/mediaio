      ...
      drawMenuItemsLeft('index', menuItems);
            ...
            if ($_SESSION["role"] >= 3) {
				...
				<ul class="navbar-nav navbarPhP">
					<li>
						<a class="nav-link disabled timelock" href="#">⌛ 
							<span id="time"> 10:00 </span>
						</a>
					</li>';
                echo '
					<li>
						<a class="nav-link disabled" href="#">Admin jogok</a>
					</li>';
                echo '
				</ul>
				<form method="post" class="form-inline my-2 my-lg-0" action=utility/userLogging.php>
					<button class="btn btn-danger my-2 my-sm-0" name="logout-submit" type="submit">' .
                    $nav_logOut .
                    '</button>
				</form>
